...
// Fast CI is intentionally opt-in. Keep only cheap, long-lived product/release
// contracts plus the small CI/cache invariants that protect the fast path itself.
// Broader Node coverage remains in test:core/nightly Quality.
