...
export const fastTests = new Set([
  ...
  "test/portfolio-pet-awful-animation-policy.test.mjs",
  "test/portfolio-pet-awful-manifest-contract.test.mjs",
  "test/portfolio-pet-sprite-runtime-contract.test.mjs",
  "test/pr-preview-media-packaging.test.mjs",
  "test/pr-preview-workflow.test.mjs",
  "test/preview-assistant-worker-contract.test.mjs",
