-- Round 3 text-review storage and decision-lock ledger.
-- Round 1 / Round 2 source tables remain unchanged.
-- Browser roles have no direct table access; runtime access is service-role-only.
...
grant select, insert, update, delete on table public.temp_text_review_round_3_items to service_role;
...
grant select, insert, update, delete on table public.temp_text_review_round_3_answers to service_role;
...
grant select, insert, update, delete on table public.temp_text_review_round_3_prior_decisions to service_role;
