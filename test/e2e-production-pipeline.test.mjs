...
test("caption QA is import-safe and uses the shared E2E runtime when executed directly", async () => {
  ...
  assert.match(source, /outputDir\s*=\s*["']artifacts\/caption-qa["']/);
...
test("package scripts expose production E2E without changing individual smoke commands", async () => {
