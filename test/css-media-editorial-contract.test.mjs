...
test("media editorial editorial family has one canonical media owner", () => {
...
test("media editorial preserves authored editorial placement inputs and responsive grid geometry", () => {
  assert.match(
    media,
...
test("media editorial keeps editorial authored inputs in the renderer rather than inventing CSS writers", () => {
...
test("media editorial editorial remains before infinite reel in media source order", () => {
...
test("media editorial follows the accepted strip family in media source order", () => {
