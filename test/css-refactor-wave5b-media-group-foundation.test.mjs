...
test("Wave5B foundation stays in the canonical media owner before later component specializations", () => {
  assert.match(
    index,
...
test("Wave5B foundation move preserves exact public media-group contract", () => {
  assert.match(
    media,
...
test("Wave5B foundation does not absorb layout variants or authored specializations", () => {
  // Keep this first slice deliberately small. Grid/compact/sequence/strip/editorial/
  // masonry/bento/infinite-reel and Brand/Jestei specializations require separate
  // source-order evidence before they move.
...
test("portfolio and project-specific media integration remain outside the canonical foundation", () => {
