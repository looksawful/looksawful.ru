...
test("media fade input fade size remains an authored portfolio input", () => {
  assert.match(
    components,
...
test("media fade input generic infinite reel does not overwrite the authored fade input", () => {
...
test("media fade input mask consumers provide the generic fade fallback at the read site", () => {
...
test("media fade input fade remediation does not invent a duplicate configuration variable", () => {
