...
test("media masonry masonry family has one canonical media owner", () => {
...
test("media masonry preserves masonry responsive column geometry", () => {
  assert.match(
    media,
...
test("media masonry keeps masonry authored inputs in the typed renderer", () => {
...
test("media masonry masonry remains before infinite reel in media source order", () => {
...
test("media masonry masonry follows editorial in media source order", () => {
