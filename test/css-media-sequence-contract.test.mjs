...
test("media sequence sequence family has one canonical media owner", () => {
...
test("media sequence sequence keeps authored configuration and intrinsic geometry contract", () => {
  assert.match(
    media,
...
test("media sequence sequence remains before infinite reel in media source order", () => {
