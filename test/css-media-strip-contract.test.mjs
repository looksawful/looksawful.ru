...
test("media strip generic strip family has one canonical media owner", () => {
...
test("media strip preserves strip intrinsic geometry and resolved configuration", () => {
  assert.match(
    media,
...
test("media strip keeps portfolio strip inputs in the component owner", () => {
  assert.match(
    components,
...
test("media strip strip remains before infinite reel in media source order", () => {
...
test("media strip follows the already accepted sequence family in media source order", () => {
