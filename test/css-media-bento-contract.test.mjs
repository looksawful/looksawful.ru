...
test("preserves compact bento rail geometry", () => {
  assert.match(
    media,
...
test("preserves wide bento fixed-grid geometry", () => {
  assert.match(
    media,
...
test("keeps bento authored inputs in typed renderers", () => {
...
test("bento remains before infinite reel in media source order", () => {
...
test("bento follows masonry in media source order", () => {
