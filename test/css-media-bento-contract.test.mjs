...
test("media bento bento family has one canonical media owner", () => {
...
test("media bento preserves compact bento rail geometry", () => {
  assert.match(
    media,
...
test("media bento preserves wide bento fixed-grid geometry", () => {
  assert.match(
    media,
...
test("media bento keeps bento authored inputs in typed renderers", () => {
...
test("media bento bento remains before infinite reel in media source order", () => {
...
test("media bento bento follows masonry in media source order", () => {
