...
test("gives infinite-reel structure one canonical media owner", () => {
...
test("keeps animated reel geometry and masking in media ownership", () => {
  assert.match(
    media,
...
test("keeps infinite-reel motion lifecycle in the motion owner", () => {
...
test("preserves runtime and authored duration boundaries", () => {
