...
test("navigation E2E wrapper migration uses the e2e tooling boundary", async () => {
  assert.equal(await exists("tools/e2e/smoke-site-navigation.mjs"), true);
  assert.equal(await exists("tools/smoke-site-navigation.mjs"), false);
});
