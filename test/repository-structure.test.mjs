...
test("site E2E wrapper migration uses the e2e tooling boundary", async () => {
  assert.equal(await exists("tools/e2e/smoke-site.mjs"), true);
  assert.equal(await exists("tools/smoke-site.mjs"), false);
});
