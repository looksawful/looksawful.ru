...
test("CV E2E wrapper migration uses the e2e tooling boundary", async () => {
  assert.equal(await exists("tools/e2e/smoke-cv.mjs"), true);
  assert.equal(await exists("tools/smoke-cv.mjs"), false);
});
