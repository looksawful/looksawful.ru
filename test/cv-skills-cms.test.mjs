...
test("CV skill transform escapes CMS copy while preserving section and paragraph markup", async () => {
  ...
  assert.doesNotMatch(transformed, /<section class="block tools"/);
  ...
  const topIndex = transformed.indexOf('class="top"');
  const experienceIndex = transformed.indexOf('class="experience-sheet"');
  const hardIndex = transformed.indexOf('class="block hard copy"');
  const techIndex = transformed.indexOf('class="block tech"');
