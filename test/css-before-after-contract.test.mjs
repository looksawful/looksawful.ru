...
test("before-after owner is imported once in stable components-layer order", () => {
...
test("preserves before-after geometry, touch, focus and reveal inputs", () => {
...
test("keeps caption and lightbox boundaries outside the component owner", () => {
...
test("keeps runtime and template contracts unchanged", () => {
