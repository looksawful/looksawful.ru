...
Status: CURRENT DEV local Desk contract. Verified against executable launcher/policy/server ownership on `dev`; release/publication authority remains separate.
