...
// Импортируем только addObjects, потому что теперь каждый canvas получает свой собственный updater.
...
export const mountThreeCanvas = (target = "#three-canvas") => {
  ...
  // Добавляем 3D-объекты в конкретную сцену и получаем функцию анимации именно для этого canvas.
