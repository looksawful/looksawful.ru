...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Uses the canonical Sensetique studio gallery data and production Justified Gallery renderer. Row composition, media presentation and responsive layout remain production-owned.",
      },
    },
  },
};
