...
const projectByPrefix = [
  ...
  ["behance-photography-and-digital-art-for-obladaet-", "shootings-obladaet"],
  ["behance-obladaet-content-covers-", "shootings-obladaet"],
  ["behance-hypression-", "shootings-hypression"],
  ["behance-ecobasik-", "shootings-behance-ecobasik"],
  ["behance-offmi-", "shootings-behance-offmi"],
  ["behance-cinema-stills-2-", "shootings-behance-cinema-stills-2"],
  ["behance-anka-model-tests-", "shootings-behance-anka-model-tests"],
  ["behance-choose-your-character-", "shootings-behance-choose-your-character"],
  ["behance-editorial-photography-", "shootings-behance-editorial-photography"],
