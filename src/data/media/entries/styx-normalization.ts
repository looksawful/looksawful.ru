...
const captionOverrides: Readonly<Record<string, { text?: string; metaFirst?: string }>> = {
  ...
  "styx-02-source-03-1x1-use-01": {
    metaFirst: "Сканировал кольцо Apocriphon на старых и современных сканерах: новые давали детальное изображение, старые — искажения и артефакты.",
  },
  ...
  "styx-02-source-03-1x1-use-02": {
    text: "Сканировал кольцо Apocriphon на старых и современных сканерах: новые давали детальное изображение, старые — искажения и артефакты.",
  },
};
