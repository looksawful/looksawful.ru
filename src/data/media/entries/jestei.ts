...
export const jesteiMediaEntries = [
  ...
  },
  {
    ...
    caption: {
        ...
        text: "К 2025 году один лендинг перестал описывать весь Jestei Pool. Появились новые инструменты и сценарии, а Event стал отдельным направлением. Мы активнее использовали таргетированную рекламу, поэтому разным аудиториям понадобились разные предложения. Запустил два лендинга и собрал каждый из промомодулей под свои рекламные задачи.",
    },
    purpose: "work"
},
  {
    ...
    caption: {
      ...
      index: 2,
      text: "Здесь пользователи видят баннеры о свежих обновлениях контента. Я заменил стоковые фотографии генеративными изображениями и переработал адаптивный компонент: для каждой рубрики теперь делаю два макета вместо пяти. Я также ввёл показ по интересам пользователя. Например, клубные диджеи, которые не заходят в Event, больше не видят его обновления. Для регулярных рубрик разработал свои визуальные концепции, поэтому креативы стали последовательными и узнаваемыми.",
    },
    purpose: "work",
  },
  {
    ...
    caption: {
      ...
      index: 9,
      text: "Я сгруппировал плейлисты и добавил заголовки и описания. Вместе с редактором и диджеями описали больше 200 плейлистов и все жанры. Для каждой группы разработал свой стиль обложек вместо однообразных стоковых картинок.",
    },
    purpose: "work",
  },
  {
  ...
  },
  {
    ...
    caption: {
      ...
      index: 11,
      text: "Я полностью переделал сценарий покупки подписки: разницу между тарифами объяснили, а предложения для разных сегментов я разделил с помощью цветовых профилей.",
    },
    purpose: "work",
  },
  {
    ...
    caption: {
      ...
      index: 12,
      text: "Мы исследовали, какие плейлисты чаще всего нужны ивент-диджеям и как спрос меняется в течение года. Разделили музыку на сезонную и постоянную, а актуальные подборки я поднял выше в навигации.",
    },
    purpose: "work",
  },
  {
    ...
    caption: {
      ...
      text: "Canvas-анимации и интерактивные виджеты знакомят пользователя с продуктом прямо на странице. Лента показывает треки, интерфейс и инструменты сервиса. Для анимаций использовал мою библиотеку Moves Awful.",
    },
    purpose: "work",
  },
  {
    ...
    caption: {
      ...
      index: 13,
      text: "Создал виджеты с предложением перейти на следующий тариф и встроил апгрейд подписки прямо в интерфейс.",
    },
    purpose: "work",
  },
  {
    ...
    caption: {
      ...
      index: 14,
      text: "Я визуально разделил отдельные плейлисты и коллекции, добавили подсказки и описания к группам. Стоковые картинки я заменил дизайнерскими обложками.",
    },
    purpose: "work",
  },
  {
  ...
  },
  {
    ...
    caption: {
      ...
      text: "Для авторских плейлистов, музыкальных постов и страниц постоянных партнёров использовал яркие цвета и геометрические формы.",
    },
    purpose: "work",
  },
  {
  ...
  },
  {
    ...
    caption: {
        ...
        index: 24,
        text: "Для регулярных рубрик подбирал общий набор метафор и идей.",
    },
    purpose: "work"
},
  {
    ...
    caption: {
      ...
      index: 25,
      text: "Перешёл от сырого стокового контента к собственному дизайну для каждой обложки.",
    },
    purpose: "work",
  },
  {
    ...
    caption: {
      ...
      index: 26,
      text: "Для части плейлистов делал минималистичные обложки.",
    },
    purpose: "work",
  },
  {
    ...
    caption: {
      ...
      index: 27,
      text: "Для таких плейлистов я выбирал одну метафору и строил вокруг неё серию обложек. Рубрика оставалась узнаваемой, а новые выпуски не повторяли друг друга.",
    },
    purpose: "work",
  },
  {
    ...
    caption: {
      ...
      index: 28,
      text: "Диджеи редко проводят профессиональные съёмки. Поэтому я использовал нейросети, геометрические паттерны и простые приёмы обработки. Так я мог регулярно выпускать яркие обложки без отдельной фотосъёмки.",
    },
    purpose: "work",
  },
  {
...
},
  {
    ...
    caption: {
        ...
        index: 30,
        text: "Для коллекций я использовал коллажи, чтобы показать вложенность. В коллекции «Спорт» есть плейлисты про хоккей, футбол и бокс. Поэтому на обложке появились клюшка, футбольные ворота и боксёрские перчатки.",
    },
    purpose: "work"
},
  {
...
},
  {
    ...
    caption: {
        ...
        index: 32,
        text: "Для сезонных коллекций разрабатывал отдельные цветовые и стилистические решения. Новогоднюю серию Event построил вокруг странных советских ёлочных игрушек.",
    },
    purpose: "work"
},
  {
    ...
    caption: {
      ...
      index: 33,
      text: "После ребрендинга стал использовать намеренно небрежные иллюстрации и метафоры. Они привлекают внимание и делают коммуникацию с подписчиками живее.",
    },
    purpose: "work",
  },
  {
...
},
  {
    ...
    caption: {
      ...
      index: 23,
      text: "Полностью переделал сценарий покупки подписки: разницу между тарифами объяснили, а предложения для разных сегментов я разделил с помощью цветовых профилей.",
    },
    purpose: "work",
  },
  {
  ...
  },
  {
    ...
    caption: {
        ...
        text: "При обычной регистрации пользователь видит все тарифы. Для переходов из таргетированной рекламы и сценария апгрейда я сделал отдельные виджеты: сначала показываем подписку, которая решает задачу пользователя, а не весь список сразу.",
    },
    purpose: "work"
},
  {
    ...
    caption: {
        ...
        text: "В 2026 году я запустил для ивент-диджеев собственную ленту треков и полностью перестроил систему поиска и фильтрации музыки.",
    },
    purpose: "work"
},
  {
    ...
    caption: {
      ...
      text: "Я перестроил выбор тональности на основе кварто-квинтового круга: минорные тональности расположили во внутреннем кольце, мажорные — во внешнем. Я оставил два режима: систему Камелота для диджеев и классическую буквенную нотацию для музыкантов.",
    },
    purpose: "work",
  },
  {
  ...
  { id: "jestei-14-source-01-4x5-use-01", assetId: "jestei-14-source-01-4x5", projectIds: ["jestei-promo-communication"], posterAssetId: "jestei-14-poster-01-4x5", purpose: "work" },
  {
    ...
    caption: {
      ...
      index: 21,
      text: "К 2025 году сервис вырос: появились новые инструменты и сценарии, а Event стал отдельным направлением. Один лендинг уже не мог точно обращаться к разным аудиториям. Поэтому запустил два и собрал каждый из промомодулей под свои рекламные задачи.",
    },
    purpose: "work",
  },
  {
