...
export const cases = [
  {
    ...
    summary:
      "Сформировал новый визуальный язык главного российского диджейского пула, разработал UX/UI-стратегию core-продуктов и два с половиной года руководил командой дизайнеров.",
    description:
  ...
  },
  {
    ...
    summary:
      "Возглавил работу над визуальной системой московского бренда украшений, аксессуаров и одежды, вдохновлённого готической романтикой и лавкрафтовским ужасом.",
    description:
  ...
  },
  {
    ...
    summary:
      "Запустил и управлял московской фотостудией и продакшеном для моды, рекламы и визуального контента. Собирал команду, продюсировал съёмки и организовывал производство.",
    description:
