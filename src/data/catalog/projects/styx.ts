...
export const styxProjects = [
  ...
  {
    ...styxBase,
    id: "styx-packaging-2024",
    name: "Упаковка Styx Jewel",
    date: "2024",
    projectTypeIds: ["packaging-project"],
    primaryRoleId: "designer",
    roleIds: ["designer", "graphic-designer"],
  },
  {
    ...styxBase,
    id: "styx-panoramic-catalog-2021",
    name: "Панорамный каталог Styx Jewel",
    date: "2021",
  ...
  {
    ...styxBase,
    id: "styx-print-materials-2023",
    name: "Печатные материалы Styx Jewel",
    date: "2023",
  ...
  },
  {
    ...
    name: "Инструкции Styx Jewel для социальных сетей",
  ...
  {
    ...styxBase,
    id: "styx-scanographic-campaign-2022",
    name: "Сканографический кампейн Styx Jewel",
    date: "2022",
    projectTypeIds: ["campaign-shooting", "scanography-project"],
    primaryRoleId: "digital-artist",
    roleIds: ["digital-artist"],
  },
