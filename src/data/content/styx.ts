...
export const styxBrandIntro = {
  ...
  paragraphs: [
    "Разработал логотип, собрал фирменный стиль, разработал дизайн упаковки, печатных материалов, соцсетей, рекламных публикаций, баннеров, продюсировал и снимал кампейны, лукбуки и каталоги, занимался технической, художественной и экспериментальной обработкой фотографий и создавал сканографические перекладные анимации и арты.",
  ],
...
export const styxScanographyIntro = {
  ...
  paragraphs: [
    "Экспериментальная технология, которую я придумал для Styx. Я по отдельности сканировал объект разными сканерами и вручную монтировал полученные кадры, чтобы все искажения и эффекты были не цифровыми, а аналоговыми.",
  ],
} as const satisfies SectionIntroData;
...
export const styxShootingsIntro = {
  ...
  paragraphs: [
    "Для Styx я продюсировал и снимал лукбуки, кампейны и коллаборации, а затем собирал из материала каталожные, рекламные и экспериментальные визуалы бренда.",
  ],
} as const satisfies SectionIntroData;
