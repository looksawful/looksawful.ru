...
export const movesAwfulAnimationsIntro = {
  ...
  paragraphs: ["На лендинге я использовал Canvas-анимации и интерактивные виджеты. Лента показывает подборки треков, интерфейс и инструменты сервиса; отдельные модули — плейлисты и музыкальные жанры. Анимированные секции для клубных диджеев построены на библиотеке Moves Awful."],
