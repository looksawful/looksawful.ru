...
export function renderBlogCard(entry: BlogEntry): string {
  ...
  return `<a class="blog-card" href="/blog/${escapeHtml(entry.slug)}/" data-blog-card data-blog-kind="${entry.kind}" data-blog-search="${escapeHtml(searchText)}">
