...
const TECH_ICONS = {
  ...
  windows: iconSvg(
    '<path d="M3 5.2 10.1 4v7.3H3V5.2Zm8.4-1.4L21 2.2v9.1h-9.6V3.8ZM3 12.7h7.1V20L3 18.8v-6.1Zm8.4 0H21v9.1l-9.6-1.6v-7.5Z" fill="currentColor"/>',
  ),
  autohotkey: iconSvg(
    '<rect x="3" y="4" width="18" height="16" rx="3" fill="currentColor"/><path d="M7 16V8h2v3h4V8h2v8h-2v-3.2H9V16H7Zm9.5 0V8H19v8h-2.5Z" fill="#fff"/>',
  ),
  hotkeys: iconSvg(
    '<rect x="3" y="5" width="18" height="14" rx="3" fill="none" stroke="currentColor" stroke-width="2"/><path d="M7 9h2M11 9h2M15 9h2M7 13h6M15 13h2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>',
  ),
  python: iconSvg(
    '<path d="M12 3c3 0 4.2 1.1 4.2 3.2v2.2H10.5c-2.2 0-4 1.4-4 3.6v1H4.8C3.2 13 2 11.7 2 9.7 2 5.4 5.7 3 12 3Z" fill="currentColor"/><path d="M12 21c-3 0-4.2-1.1-4.2-3.2v-2.2h5.7c2.2 0 4-1.4 4-3.6v-1h1.7c1.6 0 2.8 1.3 2.8 3.3C22 18.6 18.3 21 12 21Z" fill="currentColor" opacity=".65"/><circle cx="8.2" cy="6.4" r="1" fill="#fff"/><circle cx="15.8" cy="17.6" r="1" fill="#fff"/>',
  ),
  cli: iconSvg(
    '<rect x="3" y="5" width="18" height="14" rx="3" fill="currentColor"/><path d="m7 10 3 2-3 2M12 15h5" fill="none" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>',
  ),
  canvas: iconSvg(
