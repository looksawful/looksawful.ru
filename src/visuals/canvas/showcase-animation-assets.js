const LOCAL_SCENE_MODULES = {
  ...
  jesteiMotionDiagonalLoop: import.meta.glob(
    "./diagonal-loop/assets/jestei-motion-diagonal-loop/**/*.{webp,png,jpg,jpeg,avif,gif,mp4,webm}",
    { eager: true, query: "?url", import: "default" },
  ),
...
const LOCAL_SCENE_DIRECTORIES = {
  ...
  jesteiMotionDiagonalLoop: "src/visuals/canvas/diagonal-loop/assets/jestei-motion-diagonal-loop",
...
const SCENE_LABELS = {
  ...
  jesteiMotionDiagonalLoop: "Jestei Pool / motion / diagonal loop",
