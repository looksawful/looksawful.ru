const ASSET_MODULES = import.meta.glob(
  [
    "../../assets/cv/chip-content/**/*.{jpg,jpeg,png,webp,mp4}",
    "../../lab/assets/brand/colors/*.{jpg,jpeg,png,webp}",
    "../../lab/assets/brand/filter/*.{jpg,jpeg,png,webp}",
    "../../lab/assets/brand/fin/*.{jpg,jpeg,png,webp}",
    "../../lab/assets/brand/fin/promo-formats/*.{jpg,jpeg,png,webp}",
    "../../lab/assets/projects/jestei/colors/*.mp4",
    "../../lab/assets/projects/jestei/colors/source-exports/*.{jpg,jpeg,png,webp}",
    "../../lab/assets/projects/jestei/media/*.mp4",
    "../../lab/assets/projects/jestei/palette/*.{jpg,jpeg,png,webp}",
    "../../lab/assets/projects/styx/*.{jpg,jpeg,png,webp,mp4}",
    "../../lab/assets/projects/styx/archive/legacy/*.{jpg,jpeg,png,webp}",
    "../../lab/assets/projects/styx/brand/*.{jpg,jpeg,png,webp}",
  ],
  {
    eager: true,
    query: "?url",
...
const asset = (path) => {
  ...
  const assetUrl = ASSET_MODULES[normalizedPath];

  if (!assetUrl) {
    throw new Error(`[cv-task-demo-data] unresolved asset: ${path}`);
  }
...
const logoInspector = (title = "3D-превью логотипа Jestei Pool", options = {}) => ({
  type: "logo-inspector",
  title,
  ...options,
});
const newsletterCanvas = (sources, title = "canvas рассылки", options = {}) => ({
  type: "newsletter-canvas",
  sources,
  title,
  ...options,
});
...
export const CV_TASK_DEMOS = {
  "jestei-pool-02": {
    ...
    previewMedia: image(
      asset(
        "../../assets/cv/chip-content/01-jestei-pool/02-razrabotal-novyy-dizayn-filtra-dlya-trekov-dlya-dvuh-produktov/Frame 1171277132.png",
      ),
      "Frame 1171277132",
    ),
    media: [
      ...
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/02-razrabotal-novyy-dizayn-filtra-dlya-trekov-dlya-dvuh-produktov/Record Pool.png",
        ),
        "Record Pool",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/02-razrabotal-novyy-dizayn-filtra-dlya-trekov-dlya-dvuh-produktov/Screenshot 2026-05-30 163749.png",
        ),
        "Screenshot 2026 05 30 163749",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/02-razrabotal-novyy-dizayn-filtra-dlya-trekov-dlya-dvuh-produktov/Section 6.png",
        ),
        "Section 6",
      ),
    ],
    ...
    assetPath:
      "src/assets/cv/chip-content/01-jestei-pool/02-razrabotal-novyy-dizayn-filtra-dlya-trekov-dlya-dvuh-produktov",
    fileCount: 4,
  },
  "jestei-pool-05": {
    project: "Jestei Pool",
    ...
    previewMedia: image(
      asset("../../assets/cv/chip-content/01-jestei-pool/05-proizvel-redizayn-lendinga-osnovnogo-produkta/1920+.png"),
      "1920+",
    ),
    media: [
      image(
      ...
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/05-proizvel-redizayn-lendinga-osnovnogo-produkta/Billing Section.png",
        ),
        "Billing Section",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/05-proizvel-redizayn-lendinga-osnovnogo-produkta/Event Playlist Section.png",
        ),
        "Event Playlist Section",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/05-proizvel-redizayn-lendinga-osnovnogo-produkta/Exclusives Section.png",
        ),
        "Exclusives Section",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/05-proizvel-redizayn-lendinga-osnovnogo-produkta/Genres Section.png",
        ),
        "Genres Section",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/05-proizvel-redizayn-lendinga-osnovnogo-produkta/Playlists Section.png",
        ),
        "Playlists Section",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/05-proizvel-redizayn-lendinga-osnovnogo-produkta/Track List Section _1440.png",
        ),
        "Track List Section 1440",
      ),
    ],
    cards: [
      {
  ...
  "jestei-pool-07": {
    ...
    previewMedia: image(
      asset(
        "../../assets/cv/chip-content/01-jestei-pool/07-pridumal-dizayn-dlya-lendinga-ivent-didzheev/Event_block.png",
      ),
      "Event block",
    ),
    media: [
      ...
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/07-pridumal-dizayn-dlya-lendinga-ivent-didzheev/Group 3.png",
        ),
        "Group 3",
      ),
    ],
  ...
  "jestei-pool-09": {
    ...
    summary: "Интерфейсные материалы к фильтру: состояния, крупные экраны и фрагменты логики выбора.",
    previewMedia: image(
      asset("../../assets/cv/chip-content/01-jestei-pool/09-sozdal-filtr-dlya-iventa/Screenshot 2026-05-30 163911.png"),
      "Screenshot 2026 05 30 163911",
    ),
    media: [
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/09-sozdal-filtr-dlya-iventa/Screenshot 2026-05-30 163911.png",
        ),
        "Screenshot 2026 05 30 163911",
      ),
    ],
  ...
  "jestei-pool-24": {
    ...
    previewMedia: image(
      asset(
        "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/49de98d1-0fa0-4e4c-a8c2-58bce7b593fe.png",
      ),
      "49de98d1 0fa0 4e4c a8c2 58bce7b593fe",
    ),
    media: [
      image(
        asset(
      ...
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-1.png",
        ),
        "logo scheme animation frame 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-2.png",
        ),
        "logo scheme animation frame 2",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-3.png",
        ),
        "logo scheme animation frame 3",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-4.png",
        ),
        "logo scheme animation frame 4",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-5.png",
        ),
        "logo scheme animation frame 5",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-6.png",
        ),
        "logo scheme animation frame 6",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-7.png",
        ),
        "logo scheme animation frame 7",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-logo-new-1.png",
        ),
        "logo scheme animation frame logo new 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-logo-new-2.png",
        ),
        "logo scheme animation frame logo new 2",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-logo-new-3.png",
        ),
        "logo scheme animation frame logo new 3",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-logo-new.png",
        ),
        "logo scheme animation frame logo new",
      ),
      image(
        asset("../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/Поланя версия логотипа.png"),
        "Поланя версия логотипа",
      ),
      image(
        asset("../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/Схема шильда.png"),
        "Схема шильда",
      ),
    ],
    cards: [
  ...
  "jestei-pool-25": {
    ...
    previewMedia: image(
      asset("../../assets/cv/chip-content/01-jestei-pool/25-podobral-brendovyy-shrift/Desktop - 152.png"),
      "Desktop 152",
    ),
    media: [
      image(
      ...
      image(
        asset("../../assets/cv/chip-content/01-jestei-pool/25-podobral-brendovyy-shrift/Group 1171277123.png"),
        "Group 1171277123",
      ),
    ],
    cards: [
  ...
  "jestei-pool-26": {
    ...
    preview:
      "Цветовая система Jestei Pool: продуктовые темы, градиенты, состояния интерфейса и правила использования цвета в разных блоках.",
    summary:
      "Цветовая система Jestei Pool: продуктовые темы, градиенты, состояния интерфейса и правила использования цвета в разных блоках.",
    previewMedia: image(
      asset("../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Cover/colors.png"),
      "colors",
    ),
    media: [
      image(
      ...
      image(
        asset("../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Ads_block.png"),
        "Ads block",
      ),
      image(
        asset("../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Alert.png"),
        "Alert",
      ),
      image(
        asset("../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Color system site.png"),
        "Color system site",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Color system tokens.png",
        ),
        "Color system tokens",
      ),
      image(
        asset("../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Color system-1.png"),
        "Color system 1",
      ),
      image(
        asset("../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Color system-2.png"),
        "Color system 2",
      ),
      image(
        asset("../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Color system-3.png"),
        "Color system 3",
      ),
      image(
        asset("../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Color system.png"),
        "Color system",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background - layout-1.png",
        ),
        "Gradient background layout 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background - layout-2.png",
        ),
        "Gradient background layout 2",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background - layout-3.png",
        ),
        "Gradient background layout 3",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background - layout-4.png",
        ),
        "Gradient background layout 4",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background - layout-5.png",
        ),
        "Gradient background layout 5",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background - layout-6.png",
        ),
        "Gradient background layout 6",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background - layout-7.png",
        ),
        "Gradient background layout 7",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background - layout-8.png",
        ),
        "Gradient background layout 8",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background - layout-9.png",
        ),
        "Gradient background layout 9",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background - layout.png",
        ),
        "Gradient background layout",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background-1.png",
        ),
        "Gradient background 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background-2.png",
        ),
        "Gradient background 2",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background-3.png",
        ),
        "Gradient background 3",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background-4.png",
        ),
        "Gradient background 4",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Gradient background-5.png",
        ),
    ...
    cards: [
      ...
      },
      {
        ...
        media: [
          image(
            asset(
              "../../assets/cv/chip-content/01-jestei-pool/26-sozdal-cvetovuyu-palitru/Details/Color system site.png",
            ),
            "Color system site",
          ),
        ],
  ...
  "jestei-pool-33": {
    ...
    preview:
      "Серия обложек плейлистов: много визуалов в одной системе, где важно удержать ритм, узнаваемость и разнообразие.",
    summary:
      "Серия обложек плейлистов: много визуалов в одной системе, где важно удержать ритм, узнаваемость и разнообразие.",
    previewMedia: image(
      asset(
        "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/001 - День Победы 1.png",
      ),
      "001 День Победы 1",
    ),
    media: [
      ...
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/001 - Дискотека 1.png",
        ),
        "001 Дискотека 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/001 - Под гитару 1.png",
        ),
        "001 Под гитару 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/001 - Сбор гостей 1.png",
        ),
        "001 Сбор гостей 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/001 - Сбор гостей 2.png",
        ),
        "001 Сбор гостей 2",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/001 - Russian Halloween 1.png",
        ),
        "001 Russian Halloween 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/001 - Welcome 1.png",
        ),
        "001 Welcome 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/002 - Корпоратив 1.png",
        ),
        "002 Корпоратив 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/002 - Лирический фон 1.png",
        ),
        "002 Лирический фон 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/002 - Отбивки 1.png",
        ),
        "002 Отбивки 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/002 - Подложки 1.png",
        ),
        "002 Подложки 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/002 - Хиты в обработках 1.png",
        ),
        "002 Хиты в обработках 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/002 - Halloween 2025 1.png",
        ),
        "002 Halloween 2025 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/003 - 23 февраля 1.png",
        ),
        "003 23 февраля 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/003 - Выход жениха 1.png",
        ),
        "003 Выход жениха 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/003 - Гид по танцам 1.png",
        ),
        "003 Гид по танцам 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/003 - Отбивки 1.png",
        ),
        "003 Отбивки 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/003 - Подложки 1.png",
        ),
        "003 Подложки 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/003 - Свадьба 1.png",
        ),
        "003 Свадьба 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/003 - Samples 1.png",
        ),
        "003 Samples 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/004 - Видеозаставки 1.png",
        ),
        "004 Видеозаставки 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/004 - Витольд Фантастика 1.png",
        ),
        "004 Витольд Фантастика 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/004 - Выход невесты 1.png",
        ),
        "004 Выход невесты 1",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/33-sozdal-dizayn-oblozhek-pleylistov-na-sayte/Cover/004 - Масленица 1.png",
        ),
        "004 Масленица 1",
      ),
    ],
  ...
  "jestei-pool-36": {
    ...
    preview:
      "Материалы к задаче: код canvas-анимаций для лендинга, ассеты для движущихся галерей и визуальные кадры для проверки результата.",
    summary:
      "Материалы к задаче: код canvas-анимаций для лендинга, ассеты для движущихся галерей и визуальные кадры для проверки результата.",
    previewMedia: image(
      asset(
        "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/70s.webp",
      ),
      "70s",
    ),
    media: [
      ...
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/80s.webp",
        ),
        "80s",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/90s.webp",
        ),
        "90s",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/afro-house.webp",
        ),
        "afro house",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/ai.webp",
        ),
        "ai",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/amapiano.webp",
        ),
        "amapiano",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/apple-music.webp",
        ),
        "apple music",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/bass-house.webp",
        ),
        "bass house",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/billboard.webp",
        ),
        "billboard",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/blaash.webp",
        ),
        "blaash",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/drum-and-bass.webp",
        ),
        "drum and bass",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/dubstep.webp",
        ),
        "dubstep",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/khity.webp",
        ),
        "khity",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/luchshie-treki-mesyatsa.webp",
        ),
        "luchshie treki mesyatsa",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/mages.webp",
        ),
        "mages",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/memy-i-prikoly.webp",
        ),
        "memy i prikoly",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/mirovye-novinki.webp",
        ),
        "mirovye novinki",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/moombahton.webp",
        ),
        "moombahton",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/novaya-volna.webp",
        ),
        "novaya volna",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/organic-and-melodic-house.webp",
        ),
        "organic and melodic house",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/r-and-b-classic.webp",
        ),
        "r and b classic",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/rave.webp",
        ),
        "rave",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/reels-top.webp",
        ),
        "reels top",
      ),
      image(
        asset(
          "../../assets/cv/chip-content/01-jestei-pool/36-pridumal-i-napisal-animacii-dlya-lendinga/Details/canvas-animations/assets/arc/rock-hits.webp",
        ),
        "rock hits",
      ),
      code(
...
CV_TASK_DEMOS["jestei-pool-24"] = {
  ...
  summary:
    "Показываю логотип как систему: 3D-версию знака, последовательность сборки формы и статичные материалы для проверки применения.",
    ...
    frameSequence(
      [
        image(
          ...
          "схема логотипа, кадр 1",
        ),
        image(
          asset(
            "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-2.png",
          ),
          "схема логотипа, кадр 2",
        ),
        image(
          asset(
            "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-3.png",
          ),
          "схема логотипа, кадр 3",
        ),
        image(
          asset(
            "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-4.png",
          ),
          "схема логотипа, кадр 4",
        ),
        image(
          asset(
            "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-5.png",
          ),
          "схема логотипа, кадр 5",
        ),
        image(
          asset(
            "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-6.png",
          ),
          "схема логотипа, кадр 6",
        ),
        image(
          asset(
            "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-7.png",
          ),
          "схема логотипа, кадр 7",
        ),
        image(
          asset(
            "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-logo-new-1.png",
          ),
          "новый логотип, кадр 1",
        ),
        image(
          asset(
            "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-logo-new-2.png",
          ),
          "новый логотип, кадр 2",
        ),
        image(
          asset(
            "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-logo-new-3.png",
          ),
          "новый логотип, кадр 3",
        ),
        image(
          asset(
            "../../assets/cv/chip-content/01-jestei-pool/24-razrabotal-novyy-logotip/анимация схемы логотипа/logo-scheme-animation-frame-logo-new.png",
          ),
          "финальный новый логотип",
        ),
      ],
...
CV_TASK_DEMOS["jestei-pool-36"] = {
  ...
  summary:
    "В этом чипе не показываю код как главный материал. Здесь стоят сами интерактивные canvas-анимации лендинга, чтобы было видно результат движения и композиции.",
...
const styx = (path) => asset(`../../lab/assets/projects/styx/${path}`);
...
styxDemo("styx-visual-presentation", {
  ...
  media: [
    video(styx("styx-visual-system-loop.mp4"), "видео визуальной системы Styx Jewels"),
    video(styx("basement-16x9.mp4"), "видео среды бренда"),
    ...styxCampaignMedia.slice(0, 6),
  ],
});
...
styxDemo("styx-mini-studio", {
  ...
  media: [
    image(styx("bottom.jpg"), "предметный кадр Styx Jewels"),
    image(styx("1-16x9.jpg"), "визуальный язык Styx Jewels"),
    ...styxCampaignMedia.slice(4, 10),
  ],
});

styxDemo("styx-scanography", {
  title:
    "разработал концепцию сканографических анимаций для бренда и создавал их вручную при помощи сканера и принтера",
  preview: "Аналоговая часть бренда: ручная графика, сканер, принтер, плотный предметный образ.",
  previewMedia: video(styx("styx-visual-system-loop.mp4"), "видео визуальной системы Styx Jewels"),
  media: [
    video(styx("styx-visual-system-loop.mp4"), "видео визуальной системы Styx Jewels"),
    ...styxArchiveMedia,
    ...styxCampaignMedia.slice(0, 4),
  ],
  fileCount: 15,
});
...
const jesteiLab = (path) => asset(`../../lab/assets/${path}`);
const jesteiBrand = (path) => asset(`../../lab/assets/brand/${path}`);
const jesteiProject = (path) => asset(`../../lab/assets/projects/jestei/${path}`);
...
CV_TASK_DEMOS["jestei-pool-25"] = {
  ...
  summary:
    "Показываю Druk Wide как основу характера бренда: крупная геометрия, короткие сильные надписи и связка с интерфейсными материалами.",
  previewMedia: darkImage(
    asset("../../assets/cv/chip-content/01-jestei-pool/25-podobral-brendovyy-shrift/druk-wide-preview.png"),
    "Druk Wide, широкий геометрический гротеск",
  ),
  media: [
    darkImage(
      asset("../../assets/cv/chip-content/01-jestei-pool/25-podobral-brendovyy-shrift/druk-wide-preview.png"),
    ...
    darkImage(
      asset("../../assets/cv/chip-content/01-jestei-pool/25-podobral-brendovyy-shrift/Group 1171277123.png"),
      "пример Druk в системе Jestei Pool",
    ),
    darkImage(
      asset("../../assets/cv/chip-content/01-jestei-pool/25-podobral-brendovyy-shrift/Desktop - 152.png"),
      "пример брендового шрифта в интерфейсе",
    ),
  ],
  cards: [],
  assetPath: "src/assets/cv/chip-content/01-jestei-pool/25-podobral-brendovyy-shrift",
...
CV_TASK_DEMOS["jestei-pool-26"].previewMedia = video(
  jesteiProject("colors/video-jestei-bg.mp4"),
  "видео цветовой системы Jestei Pool",
);
...
CV_TASK_DEMOS["jestei-pool-05"].previewMedia = video(
  jesteiProject("media/video-jestei-bg.mp4"),
  "видео-превью лендинга Jestei Pool",
);
...
CV_TASK_DEMOS["jestei-pool-premium-products"] = {
  ...
  summary:
    "Собрал премиальные продуктовые состояния вокруг разных аудиторий: Pro, Event, Record Pool. В сайдбаре добавлен 3D-инспектор логотипа, потому что эти продукты держатся на общей фирменной системе.",
...
CV_TASK_DEMOS["jestei-pool-audience-colors"] = {
  ...
  summary:
    "Цвет здесь работает как навигация по продуктам и аудиториям: пользователь быстрее понимает, где Record Pool, где Event, где Pro. 3D-инспектор показывает, как тот же принцип переносится на логотип.",
...
CV_TASK_DEMOS["jestei-pool-brand-style"] = {
  ...
  summary:
    "Собрал фирменную систему как набор рабочих носителей: 3D-логотип, шрифт, цвета, промо-форматы и интерфейсные элементы.",
...
CV_TASK_DEMOS["jestei-pool-newsletters"] = {
  ...
  summary:
    "Подключил отдельный canvas-модуль для рассылок: внутри можно двигать и приближать длинные макеты, чтобы смотреть структуру письма не как статичную миниатюру.",
