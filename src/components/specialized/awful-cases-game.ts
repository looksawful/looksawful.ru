                ...
                <div class="mockup__viewport">
                  <div class="runner-game-shell" data-awful-cases id="runnerGameShell" tabindex="0"><canvas aria-label="awful cases trainer" data-awful-cases-canvas id="game" tabindex="0"></canvas>
                    ...
                    <div class="restart" data-awful-cases-restart hidden="" id="restartPanel">
                      ...
                      <div class="restart__meta" data-awful-cases-restart-meta id="restartMeta">WASD + PgDn / Del</div><button class="restart__button" data-awful-cases-restart-button id="restartButton" type="button">начать заново</button>
                    </div>
                    <div class="runner-controls__prompt" data-awful-cases-prompt hidden="" aria-live="polite"></div>
                    <div aria-label="Awful Cases controls" class="runner-controls" data-awful-cases-controls hidden="" id="runnerControls"><button data-runner-action="upper" data-awful-cases-action="upper" type="button"><b>W</b><span>upper</span></button><button data-runner-action="lower" data-awful-cases-action="lower" type="button"><b>S</b><span>lower</span></button><button data-runner-action="title" data-awful-cases-action="title" type="button"><b>A</b><span>title</span></button><button data-runner-action="toggle" data-awful-cases-action="toggle" type="button"><b>D</b><span>toggle</span></button><button data-runner-action="lint" data-awful-cases-action="lint" type="button"><b>PgDn</b><span>typography</span></button><button data-runner-action="sentence" data-awful-cases-action="sentence" type="button"><b>Del</b><span>sentence</span></button></div>
                  </div>
                </div>
              </div>
