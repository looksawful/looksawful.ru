              ...
              <div class="mockup__frame">
                <div class="mockup__viewport">
                  <div class="runner-game-shell" data-awful-cases id="runnerGameShell" tabindex="0"><canvas aria-label="awful cases trainer" data-awful-cases-canvas id="game" tabindex="0"></canvas>
                    ...
                    <div class="start" data-awful-cases-start id="startPanel">
                      <div class="start__label">демонстрационный режим</div><button class="start__button" data-awful-cases-start-button id="startButton" type="button">старт</button>
                    </div>
                    <div class="restart" data-awful-cases-restart hidden="" id="restartPanel">
                      ...
                      <div class="restart__meta" data-awful-cases-restart-meta id="restartMeta">только стрелочки</div><button class="restart__button" data-awful-cases-restart-button id="restartButton" type="button">начать заново</button>
                    </div>
                    <div aria-label="mobile controls" class="runner-controls" data-awful-cases-controls hidden="" id="runnerControls"><button data-runner-action="upper" data-awful-cases-action="upper" type="button"><b>Up</b><span>upper</span></button><button data-runner-action="lower" data-awful-cases-action="lower" type="button"><b>Dn</b><span>lower</span></button><button data-runner-action="title" data-awful-cases-action="title" type="button"><b>Lt</b><span>title</span></button><button data-runner-action="toggle" data-awful-cases-action="toggle" type="button"><b>Rt</b><span>toggle</span></button><button data-runner-action="lint" data-awful-cases-action="lint" type="button"><b>PgDn</b><span>typography</span></button><button data-runner-action="sentence" data-awful-cases-action="sentence" type="button"><b>Del</b><span>sentence</span></button></div>
                  </div>
                </div>
              </div>
